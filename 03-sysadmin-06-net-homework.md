...
По моим подсчётам получилось, что нужно 5 VIP адресов. Предполагая, что нагрузка на эти адреса распределяется равномерно, получается, что на каждый адрес идёт 320 Мбит/сек. Таким образом, при отказе одного из балансировщиков, мы получим на одном оставшемся 3 адреса (960 Мбит/сек), на другом - 2 адреса (640 Мбит/сек).
